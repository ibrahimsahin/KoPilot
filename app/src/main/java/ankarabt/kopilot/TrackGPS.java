...
/**
 * Created by isahin on 29.5.2017.
 */
...
public class TrackGPS extends Service implements LocationListener {
    ...
    private Location getLocation() {
        ...
        try {
            ...
            if (!checkGPS && !checkNetwork) {
                Toast.makeText(mContext, "Gps verisi alınamıyor", Toast.LENGTH_SHORT).show();
            } else {
    ...
    public void showSettingsAlert() {
        ...
        alertDialog.setTitle("GPS verisi kapalı");
        alertDialog.setMessage("GPS ayarını açmak ister misiniz?");
