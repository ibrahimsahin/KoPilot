 ...
 */
public class GuzergahTestFragment  extends Fragment {
    ...
    public void  onDestroy()
    {
       ...
       /* anlik_fragment = null;
        ...
        tabLayout = null;
        adapter = null;*/
        Log.v("test frag ","destroy");
        super.onDestroy();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView_ = inflater.inflate(R.layout.guzergah_test_fragment, container, false);
        rootView = rootView_;
    ...
    void init() {
        ...
        speedometer.setLabelTextSize(15);
        ...
        Typeface myTypeface = Typeface.createFromAsset(getContext().getAssets(), "DS-DIGIB.TTF");
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                try {
                                    ...
                                    guzergah.setMesafe(Double.valueOf(String.format("%.2f", gidilen_mesafe_metre / 1000)));
    ...
    void anlik_yazdir()  {
        if( anlik_fragment.speed_text_instant != null) {
            Log.v("ANLIK YAZILDI","print anlik");
